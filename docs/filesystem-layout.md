...
`tarlink repository status PATH [--app ID] [--platform PLATFORM] [--all-retained] [--json]`,
and `tarlink repository verify PATH [--json]`.
With no selector the commands cover all registered applications and all their
